...
def parse_args():
    ...
    parser.add_argument("--batch-key", default="donor")
...
def main():
    ...
    scvi.model.PEAKVI.setup_anndata(adata, batch_key=args.batch_key)
    ...
    adata.obsm["X_pvi"] = model.get_latent_representation()
    sc.pp.neighbors(adata, use_rep="X_pvi")
