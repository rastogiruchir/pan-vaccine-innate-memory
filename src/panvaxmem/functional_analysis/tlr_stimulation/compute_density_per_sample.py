"""Compute mrVI sample-posterior densities for TLR stimulation samples."""
...
def parse_args():
    ...
    parser.add_argument("--output-parquet", default="../outputs/tlr_stimulation/log_probs.parquet")
